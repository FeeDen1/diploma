        ...
        <View style={{ flex: 1 }}>
          ...
          */}
          ...
          <FlatList
            ...
            // отдаёт жест на перетаскивание (пан на всём шите). Android: список
            // всегда скроллится и НАТИВНО отдаёт тап Pressable-ячейке (если тут
            // выключить скролл, пан-обёртка перехватывает касания и фото
            // перестают кликаться) — поэтому пан на Android висит только на шапке.
